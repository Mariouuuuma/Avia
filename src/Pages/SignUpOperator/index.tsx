            ...
            <Form className="login-form">
              ...
              <div className="formRow">
                <div className="formNewOp-group">
                  ...
                  <Field type="text" id="firstNameNewOp"  name="firstName" required />
                  <ErrorMessage name="firstName" component="div" className="error" />
                </div>
                <div className="formNewOp-group">
                  <label htmlFor="lastNameNewOp">Last Name</label>
                  <Field type="text" id="lastNameNewOp" name="lastName" required />
              ...
              <div className="ButtonDisp">
                <div>
                  <button className="SignUp" type="submit" disabled={isSubmitting}>Sign Up</button>
                </div>
              </div>
