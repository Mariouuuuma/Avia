        ...
        <div className="containerReset">
            ...
            >
                <Form className="login-form">
                    <img src={Logo} style={{ maxWidth: '4rem', maxHeight: '4rem' }} className="Logo mx-auto" alt="Logo" />
                    ...
                    <div className="ResetPass">
                        <div className="form-group">
                            <button type="submit"><Link to="/AccountVerification">Reset Password</Link></button>
                        </div>
                    </div>
                </Form>
            </Formik>
